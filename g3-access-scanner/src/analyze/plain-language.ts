...
export const AFFECTED_USER_GROUPS: Record<string, AffectedUserGroup[]> = {
  ...
  'landmark-one-main': ['screen-reader', 'keyboard-only'],
  'landmark-no-duplicate-main': ['screen-reader'],
  'landmark-no-duplicate-banner': ['screen-reader'],
  'landmark-no-duplicate-contentinfo': ['screen-reader'],
  'landmark-banner-is-top-level': ['screen-reader'],
  'landmark-contentinfo-is-top-level': ['screen-reader'],
  'landmark-main-is-top-level': ['screen-reader', 'keyboard-only'],
  'landmark-complementary-is-top-level': ['screen-reader'],
  'landmark-unique': ['screen-reader'],
  'region': ['screen-reader', 'keyboard-only'],
};
